...
import { render, cleanup, getByTestId, getByPlaceholderText, fireEvent } from "@testing-library/react";
...
describe("Form", () => {
  ...
  it("can successfully save after trying to submit an empty student name", () => {
    ...
    const { getByText, getByPlaceholderText, queryByText } = render(
      <Form interviewers={interviewers}  interviewer={interviewers[0].id}
       onSave={onSave} />
    );
